...
psych::alpha(sass, check.keys=TRUE)[1] %>% kable()
```
...
### Network correlations between items
...
# Save plot
tiff(here::here("outputs/fig2.tiff"), units="in", width=10, height=5, res=300) 
plot(plot_ggraph)
invisible(dev.off())
```
...
### Religiosity, Self-Esteem and Perceived Stress
