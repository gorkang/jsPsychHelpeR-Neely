...
plot_form_progress = show_progress_pid(pid = params$pid_report, files_vector = DF_clean$filename, last_task = "COVIDCONTROL", goal = 850)$PLOT_progress
...
#   DF_responses =
#     DF_clean %>%
#     count(trialid, experimento, response) %>%
#     group_by(experimento, trialid) %>%
#     summarise(N = n(),
#               Responses = paste(response, collapse = ", "),
#               .groups = "drop") %>%
