...
analysis_descriptive_plots <- function(DF_joined) {
  ...
  ggsave("outputs/plots/plot_descriptive_numeric.png", plot1, dpi = 300, height = 12, width = 20)
  ...
  ggsave("outputs/plots/plot_descriptive_categorical.png", plot2, dpi = 300, height = 12, width = 20)
  } else {
    plot2 = NULL
  }
